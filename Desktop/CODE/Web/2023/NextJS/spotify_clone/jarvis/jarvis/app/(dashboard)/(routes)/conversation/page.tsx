...
const ConversationPage = () => {
    ...
    return (
        <div>
            <Heading
                title={"Conversation"}
                description={"Discute avec Jarvis"}
                icon={MessageSquare}
                ...
                <div className="space-y-4 mt-4">
                    ...
                    <div className="flex flex-col-reverse gap-y-4">
                        {messages.map((message) => (
                            <div
                                key={message.content}
                                className={cn("p-8 w-full flex items-start gap-x-8 rounded-lg", message.role === "user" ? "bg-neutral-700 border border-black/10" : "bg-neutral-600")}>
